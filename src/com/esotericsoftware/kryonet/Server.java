...
public class Server implements EndPoint {
	...
	public void bind (int tcpPort, int udpPort) throws IOException {
		...
		synchronized (updateLock) {
			...
			try {
				...
				inetSocket = new InetSocketAddress(tcpPort);
				serverChannel.socket().bind(inetSocket);
	...
	/**
	 * Returns InetSocketAddress used by server.
	 * @return InetSocketAddress used by server.
	 */
